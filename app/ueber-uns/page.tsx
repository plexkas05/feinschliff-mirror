    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          ...
          >
            <span className="inline-block py-1 px-3 rounded-full bg-slate-50 border border-slate-200 text-slate-600 text-sm font-medium mb-6">
              Seit 2026
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div
                ...
                className="aspect-square rounded-2xl bg-white border border-slate-200 flex items-center justify-center relative overflow-hidden group shadow-sm"
              >
                <span className="text-slate-400 font-medium group-hover:text-slate-700 transition-colors">Foto: Maschine</span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="aspect-square rounded-2xl bg-white border border-slate-200 flex items-center justify-center relative overflow-hidden group mt-8 shadow-sm"
              >
      ...
      <section id="kontakt" className="py-24 px-6 relative">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* Map Placeholder */}
            <div className="bg-slate-50 rounded-3xl overflow-hidden border border-slate-200 relative min-h-[300px] group">
