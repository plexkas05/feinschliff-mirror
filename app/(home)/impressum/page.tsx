    ...
    <main className="min-h-screen bg-slate-950 text-slate-300">
      ...
      <section className="container mx-auto px-6 py-32 max-w-3xl">
        ...
        <div className="space-y-8 text-sm md:text-base leading-relaxed">
          ...
          {/* Betreiber */}
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">Medieninhaber & Herausgeber</h2>
            <p className="font-bold text-white">Felix Kastner</p>
            <p>Rebenweg 12</p>
            <p>8054 Seiersberg</p>
            <p>Österreich</p>
          </div>
          ...
          <div>
            ...
            <p>Telefon: <a href="tel:+436601628017" className="hover:text-emerald-400 transition-colors">+43 660 1628017</a></p>
            <p>E-Mail: <a href="mailto:felix.kastner27@gmail.com" className="hover:text-emerald-400 transition-colors">felix.kastner27@gmail.com</a></p>
          </div>

          {/* Unternehmensdaten */}
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">Unternehmensdaten</h2>
            <p><strong>Unternehmensgegenstand:</strong> Messerschleifservice</p>
            <p><strong>Rechtsform:</strong> Einzelunternehmer (in Gründung)</p>
            
            <div className="mt-4 p-4 bg-slate-900 border border-slate-800 rounded-lg text-slate-400 italic text-sm">
          ...
          {/* Rechtliche Hinweise */}
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">Rechtliche Hinweise</h2>
            ...
            <p><strong>Zugang zu Rechtsvorschriften:</strong> <a href="https://www.ris.bka.gv.at" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 underline decoration-slate-600 underline-offset-4">www.ris.bka.gv.at</a></p>
          </div>

          {/* Mediengesetz */}
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">Blattlinie (Grundlegende Richtung)</h2>
          ...
          <div className="pt-8 border-t border-slate-800 space-y-4 text-xs text-slate-500">
            <p>
