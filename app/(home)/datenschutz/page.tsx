    ...
    <main className="min-h-screen text-slate-600">
      ...
      <section className="container mx-auto px-6 py-32 max-w-3xl">
        ...
        <div className="space-y-8 text-sm md:text-base leading-relaxed">
          ...
          {/* 2. Datenerfassung */}
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-2">2. Welche Daten wir erfassen</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-2">3. Wofür wir deine Daten nutzen</h2>
            <p>
          ...
          {/* 4. Weitergabe & Tools */}
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-2">4. Hosting & externe Dienste</h2>
            <p>Wir nutzen professionelle Dienstleister, um diesen Service sicher anzubieten:</p>

            <div className="mt-4 space-y-4">
              <div className="bg-white p-4 rounded-lg border border-slate-200/60 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)]">
                <strong className="text-slate-900 block mb-1">Vercel Inc. (Hosting)</strong>
                Hosting der Website. Vercel verarbeitet technische Log-Daten (IP-Adressen) zur Sicherheit der Plattform.
              </div>

              <div className="bg-white p-4 rounded-lg border border-slate-200/60 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)]">
                <strong className="text-slate-900 block mb-1">Supabase (Datenbank)</strong>
          ...
          {/* 5. Deine Rechte */}
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-2">5. Deine Rechte</h2>
            <p>
            ...
            <p className="mt-2">
              Kontaktiere uns dazu einfach unter: <a href="mailto:felix.kastner27@gmail.com" className="text-emerald-600 hover:underline">felix.kastner27@gmail.com</a>
            </p>
          </div>
